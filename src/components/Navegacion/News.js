...
const noticias = [
    {
      ...
      descripcion: "We invite you to participate in the 2nd Business Forum of the Bajìo A.C Aerospace Cluster, follow the conferences, panels, and meetups of the event on our platform and social networks.",
      imagen: clusterAero,
      fecha: "Oct 31, 2020",
    },
  ];
  const noticias2 = [
    {
      ...
      descripcion: "14 years streamlining global mobility through a passionate software developers team. Congratulations TEAM Optimen!",
      imagen: aniversario,
      fecha: "Oct 19, 2020",
    },
  ];
